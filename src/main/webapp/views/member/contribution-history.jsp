...
<%@ page import="com.equbidir.model.Contribution" %>
...
<head>
    ...
    <title>Contribution History - Equb & Idir</title>
...
<%
    ...
    List<Contribution> contributions = (List<Contribution>) request.getAttribute("contributions");
%>
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li><a href="<%= ctx %>/member/contribution-history"><i class="fas fa-history"></i> Contribution History</a></li>
...
<div class="main-content" id="mainContent">
    <div class="welcome-header">
        <h1><%= labelHistoryTitle %></h1>
        <a href="<%= ctx %>/views/member/dashboard.jsp" class="back-btn">
    ...
    <div class="card">
        ...
        <div class="empty-state">
            ...
            <p><%= isAm ? "ምንም መዋጮ ታሪክ የለም።" : "No contribution history recorded yet." %></p>
        </div>
        <% } else { %>
        <table>
            <thead>
            <tr>
                <th><%= isAm ? "የቡድን ስም" : "Group Name" %></th>
            ...
            <tr>
                ...
                <td><%= c.getGroupType() %></td>
                <td><%= String.format("%,.2f", c.getAmount()) %> ETB</td>
                <td class="status-<%= c.getStatus().toLowerCase() %>">
                    <%= "paid".equals(c.getStatus()) ? (isAm ? "ተከፍሏል" : "Paid") : (isAm ? "አልተከፈለም" : "Unpaid") %>
                </td>
            </tr>
            <% } %>
            </tbody>
