        ...
        <div class="btn-group">
            <%
                ...
                if ("admin".equalsIgnoreCase(user.getRole())) {
                    dashboardPath = "/views/admin/dashboard.jsp";
                } else {
                    dashboardPath = "/views/member/dashboard.jsp";
                }
            %>
        ...
        <div id="personal" class="tab-content active">
            ...
            <form action="<%= request.getContextPath() %>/profile" method="post">
                ...
                <div class="btn-group">
                    ...
                    <a href="<%= request.getContextPath() %>/views/member/dashboard.jsp" class="cancel-btn">
                        Cancel
                    </a>
                </div>
            </form>
